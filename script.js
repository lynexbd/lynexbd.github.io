// ======================================================
// LYNEX MAIN SCRIPT (Final Fixed Version)
// ======================================================
...
// Slider
window.updateActiveDot = (el, id) => { const idx = Math.round(el.scrollLeft / el.offsetWidth); const dots = document.querySelectorAll(`#slider-${id} ~ .slider-dots .dot`); dots.forEach(d => d.classList.remove('active')); if(dots[idx]) dots[idx].classList.add('active'); };
